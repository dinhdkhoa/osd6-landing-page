    ...
    return (
        <section>
            <div className="'flex flex-col gap-4 px-7 py-8 md:px-20 md:pb-14 2xl:px-96 3xl:px-[40rem]" >
                ...
                <h1 className='text-center text-3xl font-extrabold leading-3 hover:text-bosch_blue md:text-[4rem] md:mt-10'>
                    Global Service Operation SD
...
function BannerCard({ title, imageUrl, href, onClick }: BannerItem) {
  ...
  return (
    <Wrapper>
      <div
        className="relative h-28 md:h-32 w-full overflow-hidden shadow-md group"
