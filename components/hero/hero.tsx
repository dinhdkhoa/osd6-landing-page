...
const HeroSection = () => {
    return (
        <section>
            <div className="cursor-pointer px-7 py-12 md:mt-5 md:px-20 md:py-14 xl:mt-20 2xl:px-40 3xl:px-[40rem]" >
            ...
            <div className='flex flex-col gap-6 md:grid md:grid-cols-2 md:gap-0 xl:grid-cols-12 2xl:px-40 3xl:px-[40rem]'>
                <Image
                    ...
                    width={800}
                    height={450}
                    className='md:col-span-1 xl:col-span-7 xl:w-full'
                    unoptimized
                />
                <div className='flex flex-col items-center gap-3 md:ml-14 md:items-start md:gap-4 lg:ml-0 xl:col-span-3 xl:col-start-9'>
                    <Image
                        alt='bosch-hero-section'
