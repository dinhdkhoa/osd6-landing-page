...
const Solutions: SolutionProps[] = [
  ...
  //   description:
  //     "Chúng tôi cung cấp danh mục toàn diện các hệ thống an toàn đáng tin cậy và có khả năng thích ứng trong tương lai – từ bảng điều khiển và máy dò đến các giải pháp phần mềm để nâng cao hiệu quả vận hành. Các giải pháp thông minh dựa trên các công nghệ tiên tiến như AI và cảm biến thông minh để chỉ báo động trong các trường hợp khẩn cấp thực sự. Với khả năng tương thích trên toàn bộ hệ thống, các giải pháp cũng bảo vệ hiệu quả các tài sản của bạn. Các dịch vụ của chúng tôi như công cụ lập kế hoạch hoặc dịch vụ từ xa cho phép tăng cường phạm vi hoạt động và hiệu quả."
  // },
  // {
  //   img: "https://www.bosch.com.vn/media/products_and_services/20230719_find_your_way_to_our_solutions/drive_and_control_res_640x360.webp",
  //   title: "Kỹ thuật Truyền động & Điều khiển",
  //   description:
  //     "Bosch Rexroth là một trong những nhà cung cấp hàng đầu thế giới về công nghệ điều khiển và truyền động, đồng thời là đối tác toàn cầu về kỹ thuật máy móc và nhà máy. Chúng tôi tìm tòi và nghiên cứu các giải pháp tạo ra sự chuyển biến đột phá cho máy móc và dịch vụ để giúp khách hàng vươn lên vị thế dẫn đầu."
  // },
  // {
  //   img: "https://www.bosch.com.vn/media/vn/products_and_services/20240117_mobility/bbm-keyvisual_fuer_pkw_ohne_headline_overall_rgb_1920x1080-web-optimiert_res_640x360.webp",
  //   title: "Giải pháp Mobility",
  //   description:
...
const Stories: StoryProps[] = [
  {
    img: "https://www.bosch.com.vn/media/vn/stories/20220627_cw_decoding_tomorrow/decoding_tomorrow_teaser_1920x1080_res_640x360.webp",
    title: "Công nghệ Sáng tạo vì cuộc sống",
    subtitle: "Giải mã tương lai"
  },
  {
    img: "https://www.bosch.com.vn/media/vn/news/20220426_riding_innovation_in_asean/cover_photo_1920x1080_res_640x360.webp",
    title: "Đổi mới trong công nghệ xe hai bánh tại Đông Nam Á"
  },
  {
    img: "https://www.bosch.com.vn/media/vn/news/20210803_cw_innovation_trailblazers/16x9website_article_3_res_640x360.webp",
    title: "Nhà Tiên Phong Đổi Mới"
  },
  {
    img: "https://www.bosch.com.vn/media/vn/news/20210607_shifting_paradigms/16x9_bong-bot-sluice-hero_res_640x360.webp",
    title: "Công nghệ sáng tạo và đáng tin cậy",
    subtitle: "Chuyển đổi mô hình"
  },
  {
    img: "https://www.bosch.com.vn/media/vn/stories/20210330_cw_bridging_digital_divide/bima_16-9_res_640x360.webp",
    title:
      "Sự phân chia kỹ thuật số - Chiếc cầu nối thu hẹp sự phân chia của Bosch",
    subtitle: "Câu chuyện | Martin's view"
  }
]
